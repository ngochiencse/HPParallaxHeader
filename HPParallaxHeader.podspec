...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of HPParallaxHeader.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Hien Pham/HPParallaxHeader'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Hien Pham' => 'hienpham@bravesoft.com.vn' }
  s.source           = { :git => 'https://github.com/Hien Pham/HPParallaxHeader.git', :tag => s.version.to_s }
